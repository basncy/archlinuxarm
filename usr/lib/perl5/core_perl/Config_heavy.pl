...
cf_by='builduser'
cf_email=''
cf_time='Tue Feb 17 03:32:58 MST 2015'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg10='-Dsitearch=/usr/lib/perl5/site_perl'
config_arg11='-Dvendorlib=/usr/share/perl5/vendor_perl'
config_arg12='-Dvendorarch=/usr/lib/perl5/vendor_perl'
config_arg13='-Dscriptdir=/usr/bin/core_perl'
config_arg14='-Dsitescript=/usr/bin/site_perl'
config_arg15='-Dvendorscript=/usr/bin/vendor_perl'
config_arg16='-Dinc_version_list=none'
config_arg17='-Dman1ext=1perl'
config_arg18='-Dman3ext=3perl'
config_arg19='-Dlddlflags=-shared -Wl,-O1,--sort-common,--as-needed,-z,relro'
config_arg1='-des'
config_arg20='-Dldflags=-Wl,-O1,--sort-common,--as-needed,-z,relro'
config_arg2='-Dusethreads'
config_arg3='-Duseshrplib'
config_arg4='-Doptimize=-march=armv6 -mfloat-abi=hard -mfpu=vfp -O2 -pipe -fstack-protector --param=ssp-buffer-size=4'
config_arg5='-Dprefix=/usr'
config_arg6='-Dvendorprefix=/usr'
config_arg7='-Dprivlib=/usr/share/perl5/core_perl'
config_arg8='-Darchlib=/usr/lib/perl5/core_perl'
config_arg9='-Dsitelib=/usr/share/perl5/site_perl'
config_argc='20'
...
gccansipedantic=''
gccosandvers=''
gccversion='4.9.2 20141224 (prerelease)'
...
incpath=''
incpth='/usr/lib/gcc/armv6l-unknown-linux-gnueabihf/4.9.2/include /usr/local/include /usr/lib/gcc/armv6l-unknown-linux-gnueabihf/4.9.2/include-fixed /usr/include'
inews=''
...
lddlflags='-shared -Wl,-O1,--sort-common,--as-needed,-z,relro -L/usr/local/lib -fstack-protector'
ldflags='-Wl,-O1,--sort-common,--as-needed,-z,relro -fstack-protector -L/usr/local/lib'
...
libsfound=' /usr/lib/libnsl.so /usr/lib/libgdbm.so /usr/lib/libdb.so /usr/lib/libdl.so /usr/lib/libm.so /usr/lib/libcrypt.so /usr/lib/libutil.so /usr/lib/libpthread.so /usr/lib/libc.so /usr/lib/libgdbm_compat.so'
libspath=' /usr/local/lib /usr/lib/gcc/armv6l-unknown-linux-gnueabihf/4.9.2/include-fixed /usr/lib /lib'
libswanted='socket inet nsl nm gdbm dbm db malloc dl ld sun m crypt sec util pthread c cposix posix ucb BSD gdbm_compat'
...
mydomain='.nonet'
myhostname='leming'
myuname='linux leming 3.10.63-6-arch #1 smp preempt mon jan 26 20:07:35 mst 2015 armv6l gnulinux '
n='-n'
need_va_copy='undef'
...
phostname='uname -n'
pidtype='pid_t'
plibpth='/lib/armv6l-unknown-linux-gnueabihf/4.9.2 /lib /usr/lib/armv6l-unknown-linux-gnueabihf/4.9.2 /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
...
ccflags_nolargefiles='-D_REENTRANT -D_GNU_SOURCE -fwrapv -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include '
ldflags_nolargefiles='-Wl,-O1,--sort-common,--as-needed,-z,relro -fstack-protector -L/usr/local/lib'
libs_nolargefiles='-lnsl -lgdbm -ldb -ldl -lm -lcrypt -lutil -lpthread -lc -lgdbm_compat'
libswanted_nolargefiles='socket inet nsl nm gdbm dbm db malloc dl ld sun m crypt sec util pthread c cposix posix ucb BSD gdbm_compat'
EOVIRTUAL
eval {
