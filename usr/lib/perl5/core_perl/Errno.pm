...
"armv6l-linux-thread-multi-3.10.63-6-arch" or
	die "Errno architecture (armv6l-linux-thread-multi-3.10.63-6-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
